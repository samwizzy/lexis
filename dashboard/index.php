      ...
      <div class="col s12 m12 l4">
         <div id="profile-card" class="card animate fadeRight">
            <div class="card-image waves-effect waves-block waves-light">
               <img class="activator" src="<?= getenv('APP_URL') ?>assets/images/gallery/3.png" alt="user bg" />
            </div>
            <div class="card-content">
               <img src="<?= getenv('APP_URL') ?>assets/images/avatar/avatar-7.png" alt="" class="circle responsive-img activator card-profile-image cyan lighten-1 padding-2" />
